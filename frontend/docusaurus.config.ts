...
const config: Config = {
  ...
  tagline: 'Master ROS 2, Digital Twins, NVIDIA Isaac Sim, and VLA Models for Humanoid Robots',
  ...
  baseUrl: process.env.GITHUB_ACTIONS ? '/Physical-AI-Humanoid-Robotics-Course/' : '/',
